                    ...
                    <div className="overflow-x-auto">
                      <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="font-body-sm text-body-sm text-on-surface">
                          {complaints.length === 0 && <tr><td colSpan={4} className="py-8"><EmptyState title="No recent issues" body="No issues found matching the current criteria." icon="info" /></td></tr>}
